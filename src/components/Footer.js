...
const Footer = ({ footer }) => {
    return (
        <>
            ...
            <div className='mb-16 md:mb-3 md:hidden'>
                <div className='flex items-center justify-between my-3 p-2 text-sm bg-white shadow-xl rounded-lg'>
                    <div className='flex items-center'>
                        <img className='h-[25px] px-2' src="./favicon.png" alt="" />
                        <div className='-mb-4 justify-center'>
                            <p>Mi Store</p>
                            <p className='text-gray-400 -mt-5 text-xs'>Get it on GoglePlay</p>
                        </div>
                    </div>
                    <div>
                        <button className='rounded-full bg-black text-white px-3 py-1 text-xs'><a className='text-white' href="https://play.google.com/store/apps/details?id=com.mi.global.shop" target="_blank" rel="noopener noreferrer">Download</a></button>
                    </div>
                </div>

                <div className='text-gray-400 text-xs text-center'>
                        copyright © 2077-2088 Xiaomi. All Rights Reserved 
                </div>
